...
set -e
cd "$(dirname "$0")/.."
for d in firmware/esp32_terminal firmware/esp32_master firmware/uno_terminal firmware/stm32_terminal firmware/nucleo_master firmware/nucleo_terminal firmware/nucleo_repeater; do
